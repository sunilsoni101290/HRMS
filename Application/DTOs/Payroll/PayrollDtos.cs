...
namespace Application.DTOs.Payroll
{
    ...
    public class SalaryStructureListDto
    {
        ...
        // Set only when this per-employee assignment was created by
        // applying a Salary Template (single/bulk Assign) - null for
        // one-off assignments (including legacy Excel import).
        public string? SourceTemplateId { get; set; }
        public string? SourceTemplateName { get; set; }
    }

    // ==============================
    // Salary Template (reusable master - Section: Salary Structure
    // Management. See Domain/Entities/SalaryTemplate.cs remarks for how
    // this differs from SalaryStructure above, which is the actual
    ...
    public class SalaryTemplateDto
    {
        ...
        // How many DISTINCT employees currently carry an assignment
        // sourced from this template - read-only, populated on GetById.
    ...
    public class SalaryTemplateLineDto
    {
        ...
        // 1 = Fixed (only supported value today - see
        // SalaryTemplateDetail.CalculationType's remarks)
    ...
    // Bulk "Assign Salary Structure" - applies one template to many
    // employees in a single call/transaction (see SalaryTemplateService.
    // AssignAsync's remarks for the per-employee skip/overlap rules).
    ...
    public class PayrollGenerateDto
    {
        ...
        // Optional: single employee. Empty = all employees with a structure.
        [Display(Name = "Employee")]
        public string? EmployeeId { get; set; }
    ...
    public class PayrollDashboardDto
    {
        ...
        // Status breakdown (selected month)
