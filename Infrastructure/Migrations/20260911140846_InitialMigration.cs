        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VerifyMode = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                    SourceTable = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FeatureName = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
                    RequestBody = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    QueryParams = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    UserName = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "EsslAttendanceSyncStates",
                columns: table => new
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    LastProcessedDeviceLogId = table.Column<int>(type: "int", nullable: true),
                    LastProcessedLogDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastProcessedSourceTable = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: true),
                    ...
                    IsSyncRunning = table.Column<bool>(type: "bit", nullable: false),
                    TenantId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EsslAttendanceSyncStates", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SalaryProrationBasis = table.Column<int>(type: "int", nullable: false),
                    FixedWorkingDaysPerMonth = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Remarks = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    TenantId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CommunicationType = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SourceTables = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BiometricSyncLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BiometricSyncLogs_BiometricDevices_DeviceId",
                        column: x => x.DeviceId,
                        principalTable: "BiometricDevices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BiometricSyncLogs_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaidLeaveDays = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    UnpaidLeaveDays = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    PayableDays = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    ProrationBasisUsed = table.Column<int>(type: "int", nullable: true),
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    RecalculatedCount = table.Column<int>(type: "int", nullable: false),
                    LastRecalculatedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastRecalculatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TenantId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmployeeId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    EffectiveFrom = table.Column<DateTime>(type: "datetime2", nullable: false),
                    SourceTemplateId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    TenantId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BiometricAttendanceLogId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    TenantId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.BiometricAttendanceLogId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BiometricSyncLogs_Device_StartTime",
                table: "BiometricSyncLogs",
                columns: new[] { "DeviceId", "StartTime" });

            migrationBuilder.CreateIndex(
                name: "IX_BiometricSyncLogs_Tenant_SyncType_StartTime",
                table: "BiometricSyncLogs",
                columns: new[] { "TenantId", "SyncType", "StartTime" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EsslAttendanceSyncStates_Tenant",
